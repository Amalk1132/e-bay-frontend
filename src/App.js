...
const App = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8090/user/products")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8090/user/getuser", { withCredentials: true })
      .then((res) => {
  ...
  if (loading) {
    return (
      <div className="w-screen h-screen flex justify-center items-center">
        <img
          title="loading"
          src="https://res.cloudinary.com/dlxnh1sif/image/upload/v1713342125/ZZ5H_zfiteu.gif"
          width="50"
          frameBorder="0"
          class="giphy-embed"
          allowFullScreen
      ...
      >
        <Routes>
          ...
          <Route path="/" element={<Userlayout />}>
            ...
            <Route path="/tradecard" element={<TradingCards />} />
            ...
            <Route
              path="/boxingandmartialarts"
              element={<BoxingandMartial />}
            />
